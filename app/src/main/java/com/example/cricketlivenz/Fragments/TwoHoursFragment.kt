...
//import com.ensivo.tradr.databinding.FragmentTwoHoursBinding
...
// * Use the [TwoHoursFragment.newInstance] factory method to
// * create an instance of this fragment.
// */
//class TwoHoursFragment : Fragment() {
//    private lateinit var binding: FragmentTwoHoursBinding
...
//        binding = FragmentTwoHoursBinding.inflate(inflater, container, false)
//        getTwohVideo()
//        return binding.root
//    }
//
//    private fun getTwohVideo() {
//        val retrofit: Retrofit? = RetrofitClient.getInstance(false)
//        val request: WebServices? = retrofit?.create(WebServices::class.java)
//        val call: Call<SuccessModel> = request!!.getVideoList("2 Hrs Option")
...
//
//                            if (video.video_category == "2 Hrs Option") {
//                                println("Video Category 2 Hrs Option: ${video.video_category} ${video.video}")
//                                playerView = binding.twoVideo
...
//                                    binding.twoVideo.visibility = View.VISIBLE
//                                    playerView = binding.twoVideo
//                                    val videoPath = video.video
//
//                                    val mediaItem = videoPath?.let { MediaItem.fromUri(it) }
//                                    player =
//                                        SimpleExoPlayer.Builder(binding.twoVideo.context).build()
