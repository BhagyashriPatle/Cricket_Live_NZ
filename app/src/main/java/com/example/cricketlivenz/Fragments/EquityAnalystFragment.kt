...
//import com.ensivo.tradr.databinding.FragmentEquityAnalystBinding
...
//
//class EquityAnalystFragment : Fragment() {
//    private lateinit var binding: FragmentEquityAnalystBinding
//    private lateinit var linearLayoutManager: LinearLayoutManager
//    private var isClickable = 0
//
//    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,savedInstanceState: Bundle?): View {
//        binding = FragmentEquityAnalystBinding.inflate(inflater, container, false)
...
//        val call: Call<SuccessModel>? = request?.getQNAList("Equity Analyst")
