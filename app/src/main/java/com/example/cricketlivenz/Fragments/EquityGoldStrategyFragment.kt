...
//import com.ensivo.tradr.databinding.FragmentEquityGoldStrategyBinding
...
//
//class EquityGoldStrategyFragment : Fragment() {
//    private lateinit var binding: FragmentEquityGoldStrategyBinding
...
//    ): View {
//        binding = FragmentEquityGoldStrategyBinding.inflate(inflater, container, false)
//        getGoldVideo()
//        return binding.root
//    }
//
//    private fun getGoldVideo() {
//        val retrofit: Retrofit? = RetrofitClient.getInstance(false)
//        val request: WebServices? = retrofit?.create(WebServices::class.java)
//        val call: Call<SuccessModel> = request!!.getVideoList("Equity Gold")
...
//
//                            if (video.video_category == "Equity Gold") {
//                                println("Video Category Equity Gold: ${video.video_category} ${video.video}")
//                                playerView = binding.EGoldVideo
...
//                                    binding.EGoldVideo.visibility = View.VISIBLE
//                                    playerView = binding.EGoldVideo
//                                    val videoPath = video.video
//
//                                    val mediaItem = videoPath?.let { MediaItem.fromUri(it) }
//                                    player =
//                                        SimpleExoPlayer.Builder(binding.EGoldVideo.context).build()
...
//                                }
//                                binding.EGoldVideo.setOnClickListener {
//                                  parentFragmentCall()
//                                }
//
//                            } else {
